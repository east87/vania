...
class Model_label extends CI_Model
{
    ...
    function insertLabel($label_parent,$module_id, $label_title, $label_name, $type_id, $label_view,$label_notif)
    {
    ...
    function updateLabel($id,$label_parent, $module_id, $label_title, $label_name, $type_id, $label_view,$label_order,$label_notif)
    {
