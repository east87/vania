                     ...
                     <div class="m-portlet__body">
                        ...
                        <div class="modal fade" id="Modalimageurl" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
                         ...
                         <div class="form-group m-form__group row">
                           ...
                           <div class="col-lg-6">
                               <select class="form-control m-input" name="module_id" id="module_id" required="">
                        ...
                        <script language="javascript">
                           ...
                           $('#module_id').change(function(){                           
                              ...
                              if(module_id == 0) {
                                 ...
                                 $.post("<?php echo BASE_URL_BACKEND.'/category/getParentModule';?>/"+module_id+"",                           
                               function(obj){
                           
                                   $(".categoryparent").show();   
                                   $('#categoryparent').html(obj);
                        ...
                        <div class="form-group m-form__group row categoryparent" style="display: none;">
