                  ...
                  <form name="form1" action="<?php echo BASE_URL_BACKEND.'/'.$controller.'/doAdd'; ?>" method="post" role="form" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator">
                     ...
                     <div class="m-portlet__body">
                        <div class="form-group m-form__group row">
                           ...
                           <div class="col-lg-6">
                              <input name="cataloguetitle" type="text" class="form-control m-input" placeholder="catalogue Title" value="<?php if(!empty($cataloguetitle)){echo $cataloguetitle;} ?>">
                        ...
                        <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" name="cataloguefileurl" readonly="readonly" id="fileurl" class="form-control" value="<?php if(!empty($cataloguefileurl)){echo $cataloguefileurl;} ?>" onchange="setVal(this);">
