                           ...
                           $('#categoryparent').change(function(){                           
                              ...
                              if(id_category == 0) {
                               ...
                               function(obj){
                                   ...
                                   $(".id_child").show();   
                                   $('#categorysubparent').html(obj);
                           
                               }); 
                              }
                           });
                           
                              $('#categorysubparent').change(function(){                           
                                var id_subcategory = $('#categorysubparent').val();                           
                                //alert(id_category);                           
                              if(id_subcategory == 0) {
                                  $(".id_child").hide();                           
                              }                           
                              else{                           
                                 $.post("<?php echo BASE_URL_BACKEND.'/category/getSubParent';?>/"+id_subcategory+"",                           
                               function(obj){
